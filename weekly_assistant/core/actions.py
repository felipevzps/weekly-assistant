...
from core import google_calendar, note_generator, note_parser, organize_weekly_tasks, organize_google_calendar_weekly_tasks, daily_note_parser

parser = argparse.ArgumentParser(prog="weekly-assistant", description="my weekly assistant.")
group = parser.add_mutually_exclusive_group(required=True)
group.add_argument("--weekly", action="store_true", help="organize weekly notes")
group.add_argument("--daily", action="store_true", help="add daily events to weekly notes")
...
def main():
    if args.weekly:
        ...
        #print("Executando daily_note_parser.py...")
        daily_note_parser.main(inbox_dir, calendar_path)
       
        #print("Removendo arquivos temporários...")
        remove_temporary_files([calendar_path])
